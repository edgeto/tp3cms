...
class WeixinController extends BaseController {
    ...
    protected $_appId = 'wx87f5294944e5c4c6';

    protected $_appSecret = 'd4624c36b6795d1d99dcf0547af5443d';

    protected $_expire = 6000;        //微信的缓存时间是7200(秒), 由于会存在时间差, 缓存时间比微信那边要小

    protected $_token = 'yansheng'; //填写的URL需要正确响应微信发送的Token验证
    //回复文本模板
        ...
        if(!$access_token || $refresh){
            ...
            if($res){
                ...
                if(!empty($res['access_token'])){
                    S($key,$res['access_token'],$this->_expire);
