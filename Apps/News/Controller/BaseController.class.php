...
class BaseController extends Controller {
    ...
    protected function _initialize(){
        ...
        $this->assign('loginUrl',C("DEFAULT_URL.USER").'/public/login?referer_url='.C("DEFAULT_URL.NEWS").__SELF__);
        //配置
        $this->config();
        //导航
        $this->nav();
    ...
    public function config(){
        ...
        //标题、关键词和描述
        $this->assign('title',C('news_title').'-'.C('main_title'));
        $this->assign('keywords',C('news_keywords'));
        $this->assign('description',C('news_desc'));
